...
public class digitalTwin {
    ...
    public static void main(String[] args) {
        try {
            ...
            Log.printLine("Digital Twin Simulation finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static void linkSensorsAndActuatorsToFogDevices(int userId, String appId, FogDevice edgeDevice) {
        ...
        Sensor humiditySensor = new Sensor("humiditySensor-" + edgeDevice.getName(), "HUMIDITY", userId, appId, new DeterministicDistribution(5)); // Generates data every 5 seconds
    ...
    private static Application createApplication(String appId, int userId) {
        ...
        application.addTupleMapping("humidity_module", "HUMIDITY", "HUMIDITY_ALERT", new FractionalSelectivity(0.3));

        // Define loops to monitor for latency-sensitive operations
