...
public class IoTSportsSector {
    ...
    public static void main(String[] args) {
        try {
            ...
            Log.printLine("Sports Monitoring Simulation finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static Application createApplication(String appId, int userId) {
        ...
        application.addTupleMapping("accelerometer_module", "ACCELEROMETER", "ACCELEROMETER_ALERT", new FractionalSelectivity(0.5));
        application.addTupleMapping("heart_rate_module", "HEART_RATE", "HEART_RATE_ALERT", new FractionalSelectivity(0.3));
