...
public class industrymahesh {

    static List<FogDevice> fogDevices = new ArrayList<>();
    static List<Sensor> sensors = new ArrayList<>();
    static List<Actuator> actuators = new ArrayList<>();
    static int numOfAreas = 3; // Updated to 3 areas
    ...
    public static void main(String[] args) {
        try {
            ...
            String appId = "industrialAutomation";
            ...
            Log.printLine("Industrial Automation Simulation finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static void createFogDevices(int userId, String appId) throws Exception {
        ...
        // Create edge devices for each area
    ...
    private static void linkSensorsAndActuatorsToFogDevices(int userId, String appId, FogDevice edgeDevice) {
        Sensor tempSensor = new Sensor("tempSensor-" + edgeDevice.getName(), "TEMPERATURE", userId, appId, new DeterministicDistribution(5)); // Generates data every 5 seconds
        ...
        Sensor lightSensor = new Sensor("lightSensor-" + edgeDevice.getName(), "LIGHT", userId, appId, new DeterministicDistribution(4)); // Generates data every 4 seconds
        lightSensor.setGatewayDeviceId(edgeDevice.getId());
        sensors.add(lightSensor);

        Sensor motionSensor = new Sensor("motionSensor-" + edgeDevice.getName(), "MOTION", userId, appId, new DeterministicDistribution(6)); // Generates data every 6 seconds
    ...
    private static Application createApplication(String appId, int userId) {
        ...
        application.addAppEdge("TEMPERATURE", "temp_module", 1000, 2000, "TEMPERATURE", Tuple.UP, AppEdge.SENSOR);
        ...
        application.addTupleMapping("light_module", "LIGHT", "LIGHT_ALERT", new FractionalSelectivity(0.7));
        application.addTupleMapping("motion_module", "MOTION", "MOTION_ALERT", new FractionalSelectivity(0.5));
